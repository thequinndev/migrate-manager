      ...
      group: z
        .object({
          upFileFormat: z
            .string()
            .optional()
            .default("{{prefix}}_{{increment}}_{{groupName}}.up.sql"),
          downFileFormat: z
            .string()
            .optional()
            .default("{{prefix}}_{{increment}}_{{groupName}}.down.sql"),
        })
        .optional(),
    })
    .optional()
...
export type MigrationManagerConfig = z.infer<
  typeof migrationManagerConfigSchema
>;
...
export const parseChangesetConfig = (config: any) => {
